                    ...
                    <div className="header-wrapper" id="header-wrapper">
                        ...
                        <div className="header-right">
                            <nav className="mainmenunav d-lg-block">
                                <Scrollspy className="mainmenu" items={['home', 'about', 'portfolio','team','testimonial','blog', 'contact']} currentClassName="is-current" offset={-200}>
                                                    ...
                                                    <div className="content">
                                                        <div className="inner">
                                                            ...
                                                            <div className="portfolio-button">
                                                                <a className="rn-btn" href="/portfolio-details">See Projet</a>
                                                            </div>
                                                        </div>
                                                    </div>
