          ...
          <div className='header-wrapper' id='header-wrapper'>
            ...
            <div className='header-right'>
              <nav className='mainmenunav d-lg-block'>
                <Scrollspy
                  className='mainmenu'
                  items={["home", "service", "getstart", "about", "team", "testimonial", "portfolio"]}
              ...
              <div className='col-lg-8'>
                <div className='feature-area'>
                  ...
                  <h3 className='title mt--20 fontWeight500 lineheight--1-8'>
                    What you look your hopefull house we can be made it for yours. We can be design yours
                    house so dont woory you can hire us. Beautiful and hand made design we can be create.
                  </h3>
                </div>
              </div>
            </div>
            ...
            <div className='row'>
              <div className='col-lg-8'>
                <div className='inner text-left'>
                  ...
                  <a className='rn-button-style--2 mt--70 mt_sm--30 mt_md--30' href='/contact'>
          ...
          <div className='row row--0 align-items-center'>
            ...
            <div className='col-lg-12 col-xl-6 mt_lg--50 mt_md--30 mt_sm--30'>
              <div className='content'>
                ...
                <p>
                  Uniq interior design provide for your home. you can be create as you like. Our modern
                  designer provide as you are like. A interior designer can build your design and fullfile
                  your demand.Uniq interior design provide for your home. you can be create as you like. Our
                  modern designer provide as you are like. A interior designer can build your design and
                  fullfile your demand
                </p>
