        ...
        <Tabs>
          <TabPanel>
            <div className='rn-testimonial-content text-center'>
              <div className='inner'>
                <p>
                  Aklima The standard chunk of Lorem Ipsum used since the 1500s is reproduced below for those
          ...
          <TabPanel>
            <div className='rn-testimonial-content text-center'>
              <div className='inner'>
                <p>
                  John Doe The standard chunk of Lorem Ipsum used since the 1500s is reproduced below for
                  those interested. Sections Bonorum et Malorum original.
                </p>
              </div>
              <div className='author-info'>
          ...
          <TabPanel>
            <div className='rn-testimonial-content text-center'>
              <div className='inner'>
                <p>
                  Lorem Ipsum used since the 1500s is reproduced below for those interested. Sections Bonorum
                  et Malorum original.
                </p>
              </div>
              <div className='author-info'>
          ...
          <TabList className='testimonial-thumb-wrapper'>
            ...
            <Tab>
              <div className='testimonial-thumbnai'>
                <div className='thumb'>
                  <img src='public/assets/images/client/testimonial-4.jpg' alt='Testimonial Images' />
                </div>
              </div>
            </Tab>
            <Tab>
              <div className='testimonial-thumbnai'>
                <div className='thumb'>
                  <img src='public/assets/images/client/testimonial-5.jpg' alt='Testimonial Images' />
                </div>
              </div>
            </Tab>
            <Tab>
              <div className='testimonial-thumbnai'>
                <div className='thumb'>
                  <img src='public/assets/images/client/testimonial-6.jpg' alt='Testimonial Images' />
                </div>
              </div>
            </Tab>
            <Tab>
              <div className='testimonial-thumbnai'>
                <div className='thumb'>
                  <img src='public/assets/images/client/testimonial-7.jpg' alt='Testimonial Images' />
                </div>
              </div>
            </Tab>
            <Tab>
              <div className='testimonial-thumbnai'>
                <div className='thumb'>
                  <img src='public/assets/images/client/testimonial-8.jpg' alt='Testimonial Images' />
                </div>
              </div>
            </Tab>
          </TabList>
