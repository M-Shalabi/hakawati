...
class Header extends Component {
  ...
  render() {
    ...
    let logoUrl;
    if (logo === "light") {
      logoUrl = <img src='public/assets/images/logo/logo-light.png' alt='Digital Agency' />;
    } else if (logo === "dark") {
      logoUrl = <img src='public/assets/images/logo/logo-dark.png' alt='Digital Agency' />;
    } else if (logo === "symbol-dark") {
      logoUrl = <img src='public/assets/images/logo/logo-symbol-dark.png' alt='Digital Agency' />;
    } else if (logo === "symbol-light") {
      logoUrl = <img src='public/assets/images/logo/logo-symbol-light.png' alt='Digital Agency' />;
    } else {
      logoUrl = <img src='public/assets/images/logo/logo.png' alt='Digital Agency' />;
    }
