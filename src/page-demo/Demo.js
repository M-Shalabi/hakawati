              ...
              <div className='row'>
                <div className='col-lg-8 col-xl-5'>
                  <div className='inner'>
                    ...
                    <p className='title'>
                      Welcome to TryDO React Creative Agency, React Portfolio and Corporate Multi Purpose
              ...
              <div className='row'>
                <div className='col-lg-12'>
                  <div className='section-title text-center pb--30'>
                    ...
                    <p>
                      Choose one of styles or cutomize easily your site following your ideas. <br /> More
                  ...
                  <div className='faq-area'>
                    <Accordion className='accodion-style--1' preExpanded={"0"}>
                      <AccordionItem>
                        ...
                        <AccordionItemPanel>
                          <p>
                            Welcome to TryDO React Creative Agency, React Portfolio and Corporate Multi
                            Purpose Template Built With React JS. NO jQuery!. It works too much faster loading
                            speed and you can works too much comfortability.Trydo create your website so much
                      ...
                      <AccordionItem>
                        ...
                        <AccordionItemPanel>
                          <p>
                            You can run trydo easily. First You'll need to have node and npm on your machine.
                            So Please open your command prompt then check your node -v and npm -v Version.
                            Goes To Your your command prompt: then First: <strong>npm install</strong>
                          </p>
                          <p>
                            At Last: <strong>npm run start</strong>. By the following way you can be run your
                            project easily.
                          </p>
                        </AccordionItemPanel>
                      </AccordionItem>
                        ...
                        <AccordionItemPanel>
                          <div>
                            <p>
                              ...
                              http://localhost:3000 you can showing any page as your you are like. First you
                              have to go index.js page then:
                            </p>
                            <p>
                              First Step (replace your choose demo page): Example: import Demo form
                              './home/MainDemo' Instead of './home/PortfolioLanding'
                            </p>
                            <p>
                              Example:{" "}
                              <a
                      ...
                      <AccordionItem>
                        ...
                        <AccordionItemPanel>
                          <p>
                            After purchasing the product need you any support you can be share with us with
                            sending mail to{" "}
                      ...
                      <AccordionItem>
                        ...
                        <AccordionItemPanel>
                          <p>
                            Yes, We will get update the Trydo. And you can get it any time. Next time we will
                            comes with more feature. You can be get update for unlimited times. Our dedicated
                      ...
                      <AccordionItem>
                        ...
                        <AccordionItemPanel>
                          <p>
                            Yes, You can change any component as you like. And By the way you can build your
                      ...
                      <AccordionItem>
                        ...
                        <AccordionItemPanel>
                          <p>
                            ...
                            component are available include in this templete. And you can be use it following
                            documentation.
                          </p>
                        </AccordionItemPanel>
                      </AccordionItem>
